...
interface UiState {
  ...
  /** Off by default — swaps Monaco's own keybindings for `monaco-vim`'s
   * modal editing (normal/insert/visual) on every open file/diff/merge
   * editor. See Settings → Editor. */
