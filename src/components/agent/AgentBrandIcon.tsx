...
// Aider ships no official mark suitable for a monochrome 24px glyph, so
// this is a neutral terminal-prompt shape rather than a guess at branding.
const AIDER_PATH =
